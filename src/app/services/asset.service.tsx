        ...
        return new Promise((resolve, reject) => {
            ...
            apiInstance.postRequest(eventURL, brandingBody).then(brandingResponse => {
                if (brandingResponse.data.data.length) {
                    const brandings = ambrosusSdk.utils.findEvent('branding', brandingResponse.data.data);
                    resolve(brandings);
                }
                resolve({});
            }).catch(err => reject(err));
        ...
        return new Promise((resolve, reject) => {
            ...
            apiInstance.postRequest(eventURL, body).then(eventsResponse => {
                ...
                const details = {
                    ...
                    events: parsedEvents.events.sort(ambrosusSdk.utils.sortEventsByTimestamp),
                };
                resolve(details);
            }).catch(err => {
                reject(err);
